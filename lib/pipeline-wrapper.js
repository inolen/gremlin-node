...
PipelineWrapper.prototype.count = pipeWrap('count');
...
PipelineWrapper.prototype.toArray = pipeWrap('toArray');
...
PipelineWrapper.prototype.next = function (callback) {
  ...
  this.pipeline.next(function (err, res) {
    ...
    if (res && gremlin.isType(res, 'com.tinkerpop.blueprints.Vertex')) {
