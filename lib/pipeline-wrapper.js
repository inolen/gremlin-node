...
PipelineWrapper.prototype._javify = function (arg) {
  ...
  if (arg.unwrap) {
    ...
    return gremlin.getEngine().evalSync(arg);
  }
...
PipelineWrapper.prototype._jsify = function (arg) {
  ...
  } else if (gremlin.isType(arg, 'com.tinkerpop.blueprints.Vertex')) {
    return new gremlin.VertexWrapper(gremlin, arg);
  } else if (gremlin.isType(arg, 'com.tinkerpop.blueprints.Edge')) {
    return new gremlin.EdgeWrapper(gremlin, arg);
  } else if (gremlin.isType(arg, 'java.util.Map')) {
