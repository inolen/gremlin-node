...
// export so modules can append to their prototypes easily
Gremlin.GraphWrapper = GraphWrapper;
Gremlin.QueryWrapper = QueryWrapper;
Gremlin.PipelineWrapper = PipelineWrapper;
...
Gremlin.prototype.wrap = function(graph) {
  return new GraphWrapper(this, graph);
};
